...
// Floor Level PDF Imports for Full Building Floor Plans
import MU90_0_FloorPdf from "../../assets/drawings/m3north/plans/MU90/MU90.0/MU90.0.pdf";
import MU90_1_FloorPdf from "../../assets/drawings/m3north/plans/MU90/MU90.1/MU90.1.pdf";
import MU90_2_FloorPdf from "../../assets/drawings/m3north/plans/MU90/MU90.2/MU90.2.pdf";
import MU90_R_FloorPdf from "../../assets/drawings/m3north/plans/MU90/MU90.R/MU90.R.pdf";

import MU91_0_FloorPdf from "../../assets/drawings/m3north/plans/MU91/MU91.0/GroundFloor.pdf";
import MU91_1_FloorPdf from "../../assets/drawings/m3north/plans/MU91/MU91.1/FirstFloor.pdf";
import MU91_2_FloorPdf from "../../assets/drawings/m3north/plans/MU91/MU91.2/Zones/MU91.2F.pdf";
import MU91_3_FloorPdf from "../../assets/drawings/m3north/plans/MU91/MU91.3/Zones/MU91.3F.pdf";
import MU91_4_FloorPdf from "../../assets/drawings/m3north/plans/MU91/MU91.4/Zones/MU91.4F.pdf";
import MU91_R_FloorPdf from "../../assets/drawings/m3north/plans/MU91/MU91.R/Roof.pdf";

import MA_GF_FloorPdf from "../../assets/drawings/m3north/plans/MA/GroundFloor/GroundFloor.pdf";
import MA_1F_FloorPdf from "../../assets/drawings/m3north/plans/MA/FirstFloor/FirstFloor.pdf";
import MA_2F_FloorPdf from "../../assets/drawings/m3north/plans/MA/SecondFloor/SecondFloor.pdf";
import MA_3F_FloorPdf from "../../assets/drawings/m3north/plans/MA/ThirdFloor/ThirdFloor.pdf";
import MA_R_FloorPdf from "../../assets/drawings/m3north/plans/MA/Roof/Roof.pdf";

import MABasement_FloorPdf from "../../assets/drawings/m3north/plans/MABasement/MA_B.pdf";

import MAII_0_FloorPdf from "../../assets/drawings/m3north/plans/MAII/GroundFloor/MA.II_0.pdf";
import MAII_1_FloorPdf from "../../assets/drawings/m3north/plans/MAII/FirstFloor/MA.II_1.pdf";
import MAII_2_FloorPdf from "../../assets/drawings/m3north/plans/MAII/SecondFloor/MA.II_2.pdf";
import MAII_3_FloorPdf from "../../assets/drawings/m3north/plans/MAII/ThirdFloor/MA.II_3.pdf";
import MAII_R_FloorPdf from "../../assets/drawings/m3north/plans/MAII/Roof/MA.II_R.pdf";

import MAIII_0_FloorPdf from "../../assets/drawings/m3north/plans/MAIII/GroundFloor/MA.III_0.pdf";
import MAIII_1_FloorPdf from "../../assets/drawings/m3north/plans/MAIII/FirstFloor/MA.III_1.pdf";
import MAIII_2_FloorPdf from "../../assets/drawings/m3north/plans/MAIII/SecondFloor/MA.III_2.pdf";
import MAIII_3_FloorPdf from "../../assets/drawings/m3north/plans/MAIII/ThirdFloor/MA.III_3.pdf";
import MAIII_R_FloorPdf from "../../assets/drawings/m3north/plans/MAIII/Roof/MA.III_R.pdf";

import MB_0_FloorPdf from "../../assets/drawings/m3north/plans/MB/GroundFloor/MB_GroundFloor.pdf";
import MB_1_FloorPdf from "../../assets/drawings/m3north/plans/MB/FirstFloor/MB_FirstFloor.pdf";
import MB_2_FloorPdf from "../../assets/drawings/m3north/plans/MB/SecondFloor/MB_SecondFloor.pdf";
import MB_R_FloorPdf from "../../assets/drawings/m3north/plans/MB/RoofFloor/MB_Roof.pdf";

import External_FloorPdf from "../../assets/drawings/m3north/plans/external/External.pdf";

const FLOOR_LEVEL_PDF_MAP = {
  "MU90.0": MU90_0_FloorPdf,
  "MU90.1": MU90_1_FloorPdf,
  "MU90.2": MU90_2_FloorPdf,
  "MU90.R": MU90_R_FloorPdf,

  "MU91.0": MU91_0_FloorPdf,
  "MU91.1": MU91_1_FloorPdf,
  "MU91.2": MU91_2_FloorPdf,
  "MU91.3": MU91_3_FloorPdf,
  "MU91.4": MU91_4_FloorPdf,
  "MU91.R": MU91_R_FloorPdf,

  "Ground Floor": MA_GF_FloorPdf,
  "First Floor": MA_1F_FloorPdf,
  "Second Floor": MA_2F_FloorPdf,
  "Third Floor": MA_3F_FloorPdf,
  "Roof Plan": MA_R_FloorPdf,

  "MA Basement": MABasement_FloorPdf,

  "MA.II 0": MAII_0_FloorPdf,
  "MA.II 1": MAII_1_FloorPdf,
  "MA.II 2": MAII_2_FloorPdf,
  "MA.II 3": MAII_3_FloorPdf,
  "MA.II R": MAII_R_FloorPdf,

  "MA.III 0": MAIII_0_FloorPdf,
  "MA.III 1": MAIII_1_FloorPdf,
  "MA.III 2": MAIII_2_FloorPdf,
  "MA.III 3": MAIII_3_FloorPdf,
  "MA.III R": MAIII_R_FloorPdf,
  ...
  "External Areas": External_FloorPdf,
};
...
const formatCompanyLogoUrl = (logoVal) => {
  ...
  if (cleanPath.startsWith("subcontractors/")) {
    return `https://api.beam.safesiteworks.com/m3north/${cleanPath}`;
  }
  return `https://api.beam.safesiteworks.com/m3north/subcontractors/${cleanPath}`;
};
...
function ExecutiveDashboard() {
  ...
  useEffect(() => {
    ...
    if (activeTab === "Overview") {
      const bName = selectedBuilding || "MU90";
  ...
  const levels = useMemo(() => {
    ...
    if (bClean === "mu90") {
      return ["MU90.0", "MU90.1", "MU90.2", "MU90.R"];
    }
    if (bClean === "mu91") {
      return ["MU91.0", "MU91.1", "MU91.2", "MU91.3", "MU91.4", "MU91.R"];
    }
    if (bClean === "ma") {
      return ["Ground Floor", "First Floor", "Second Floor", "Third Floor", "Roof Plan"];
    }
    if (bClean === "mabasement" || bClean === "ma basement") {
      return ["MA Basement"];
    }
    if (bClean === "ma.ii" || bClean === "maii") {
      return ["MA.II 0", "MA.II 1", "MA.II 2", "MA.II 3", "MA.II R"];
    }
    if (bClean === "ma.iii" || bClean === "maiii") {
      return ["MA.III 0", "MA.III 1", "MA.III 2", "MA.III 3", "MA.III R"];
    }
    if (bClean === "mb") {
      return ["MB.0", "MB.1", "MB.2", "MB.R"];
    }
    if (bClean === "external" || bClean === "externalareas" || bClean === "external areas") {
      return ["External Areas"];
    }
  ...
  const selectedPdf = useMemo(() => {
    if (selectedLevel && FLOOR_LEVEL_PDF_MAP[selectedLevel]) {
      return FLOOR_LEVEL_PDF_MAP[selectedLevel];
    }
    return selectedLevelZones[0]?.pdf || null;
  }, [selectedLevel, selectedLevelZones]);
